...
// Design System Mobile v2.0 색상 토큰. ChalNa 식별자명은 그대로 두고 값만 다나와 톤으로 교체.
public enum ChalNaColor {
    ...
    public enum Purple {
        ...
        public static let p600 = Color(hex: 0x8B38E5)  // Primary
    ...
    public static let info    = Color(hex: 0x02B8D3)  // Cyan
